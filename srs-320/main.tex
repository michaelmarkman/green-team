...
\textit{Title: }{\selectlanguage{english}\bfseries\color{black} Enter new restaurant for use by inspection form}
...
\begin{itemize}
\item{Septic tank:}  Septic tank objects holds fields and data from septic tank inspection forms.  These objects are stored in the database and can retrieved using search options.
