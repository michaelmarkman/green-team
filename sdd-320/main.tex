...
{\selectlanguage{english}\rmfamily\color{black}
All classes and functions described in this section will be written in Javascript and will utilize the following libraries:
\begin{itemize}
\item Library 1 
\item Library 2 
\end{itemize}
...
\subsubsection[Browsing and Search]{\selectlanguage{english}\rmfamily\bfseries\color{black}
Browsing and Search}
INSERT SEARCH BEORE SCREEN HERE
...
INSERT SEARCH AFTER SCREEN HERE

The search will also provide suggestions as the user types out the term. When the user selects a form that they have found,  options to view, edit, email, and print will appear.

INSERT SORT DATA SCREEN HERE
INSERT SORT CATEGORY SCREEN HERE

Three categories appear underneath the header. These categories are restaurants, wells, and septic tanks. Each category can be scrolled horizontally similar to Netflix's category functionality. Thumbnails of each document are sorted by most recent left to right. 

INSERT SPECIFIC CATEGORY SCREEN HERE

When the user taps on a category, it expands the category to the full screen and displays all of the document thumbnails in that category with a vertical scroll.

When the user taps on a thumbnail, there will be options to view, edit, email, and print. 

\subsubsection[Form Entry]{\selectlanguage{english}\rmfamily\bfseries\color{black}
Form Entry}

INSERT RESTAURANT SCREEN HERE

INSERT SEPTIC SCREEN HERE

Upon choosing a form, the tablet displays a simple blank form with fillable text fields. For the restaurant inspection form, information is split into different sections. Each section will be color coded similarly to the paper form currently used.
...
\subsubsection[Delayed Upload]{\selectlanguage{english}\rmfamily\bfseries\color{black}
Delayed Upload}
INSERT ICON SCREEN HERE

INSERT MODAL/POPUP SCREEN HERE
